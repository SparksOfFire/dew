...
namespace Sof.Core
{
    ...
    public static class ServiceFactory
    {
        ...
        private static Sof.Core.IServiceProvider GetProvider()
        {
    ...
    /// 服务提供程序集合
    /// </summary>
    public class ServiceProviderCollection : Collection<Sof.Core.IServiceProvider>
    {
        public Sof.Core.IServiceProvider this[string typeName]
        {
            get
            {
